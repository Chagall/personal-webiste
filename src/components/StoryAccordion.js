      ...
      <AccordionDetails className={styles.details}>
        <div>
          <Typography color="textSecondary" align="justify" paragraph>
            ...
            decided to install a couple of games before handing it over. One of
            them being{" "}
            <a
          ...
          <Typography color="textSecondary" align="justify" paragraph>
            ...
            <code>programming</code> when me and a few friend who used to play{" "}
            <a
          ...
          <Typography color="textSecondary" align="justify" paragraph>
            ...
            while talking to a friend (one of those who helped build that Tibia
            server) I came to the conclusion that law was definitely not what I
            wanted to work with. I liked computers and games, that was what I
            was supposed to be doing. So before the semester started, I decided
            to quit my university and go back to study to be accepted at a
            computer science course.
          </Typography>
          <Typography color="textSecondary" align="justify" paragraph>
            Since I was giving up on so much I decided to study hard and aim at
            the best university I could get into. That commitment let me to be
            accepted at{" "}
            <a
          ...
          <Typography color="textSecondary" align="justify" paragraph>
            Well, as far as I can remember and summarize, that&apos;s how I got
            into this life of programming and computer science…
          </Typography>
        </div>
      </AccordionDetails>
    </Accordion>
